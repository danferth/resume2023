...
const Navigation = () => {
  const style = `w-6 h-6 outline-current text-stone-600 hover:text-amber-600 transition`;
  return (
    <div className="py-4 mb-12 bg-gradient-to-b from-stone-100 to-white text-center">
