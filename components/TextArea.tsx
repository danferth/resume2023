const TextArea = (props: {
  ...
  return (
    <div className="relative rounded-md border border-stone-300 px-3 py-2 shadow-sm focus-within:border-amber-600 focus-within:ring-1 focus-within:ring-amber-600">
      <label
        htmlFor={props.id}
