  ...
  return (
    <article className="mt-4 mb-6">
      <div className="bg-stone-100 w-full h-full py-4 px-6 rounded-md shadow overflow-none lg:bg-white lg:shadow-none lg:rounded-none lg:border-b-2 lg:border-stone-100 lg:px-0">
        ...
        <p className="text-sm md:text-base text-stone-900 text-center leading-relaxed pb-4 border border-dotted border-stone-700 border-b-4 border-t-0 border-l-0 border-r-0 lg:border-stone-200 lg:max-w-2xl lg:text-left lg:text-stone-500">
          {props.description}
        </p>
